      ...
      <div className="container mx-auto px-6 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-[#003087] text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-[#009cde] transition-transform transform hover:scale-105 inline-flex items-center justify-center gap-3"
          >
            <svg
              aria-hidden="true"
              viewBox="0 0 24 24"
